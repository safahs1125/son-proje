...
export default function CalendarTab({ studentId }) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6 gradient-card">
          ...
          <Calendar
            ...
            modifiersStyles={{
              hasNote: { fontWeight: 'bold', backgroundColor: 'rgba(139, 92, 246, 0.2)' }
            }}
          />
        </Card>
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <Dialog open={openDialog} onOpenChange={setOpenDialog}>
              <DialogTrigger asChild>
                <Button size="sm" data-testid="add-calendar-note-button" className="bg-gradient-to-r from-violet-500 to-purple-600">
              ...
              <DialogContent>
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <Button onClick={handleAddNote} className="w-full" data-testid="create-calendar-note-button">
                    Not Ekle
                  </Button>
                </div>
              </DialogContent>
          ...
          <div className="space-y-3">
            {selectedDateNotes.length === 0 ? (
              ...
              selectedDateNotes.map((note) => (
                <div key={note.id} className="p-4 bg-white rounded-lg shadow-sm" data-testid={`calendar-note-${note.id}`}>
                  <div className="flex justify-between items-start">
                    ...
                    <Button
                      ...
                      data-testid={`delete-calendar-note-${note.id}`}
                    >
